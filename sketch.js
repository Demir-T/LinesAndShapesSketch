function setup() {
  ...
  triangle(690, 115, 710, 115, 700, 125); // Mouth
  ...
  // Connection between them (holding hands)
  ...
  line(150, 350, 150, 400); // Inner detail lines
  ...
  rect(290, 430, 20, 20); // Left tent top
  triangle(380, 550, 430, 450, 480, 550); // Right tent
  rect(420, 430, 20, 20); // Right tent top
